...
cd libestr
git pull
autoreconf -fvi && ./configure && make -j2 || exit $?
...
cd liblogging
git pull
autoreconf -fvi && ./configure --disable-journal && make -j2 || exit $?
sudo make install || exit $?
...
cd liblognorm
git pull
autoreconf -fvi && ./configure --enable-compile-warnings=yes && make -j2 || exit $?
sudo make install || exit $?
...
echo "./configure -enable-testbench --enable-imdiag --enable-imfile --enable-impstats --enable-imptcp --enable-mmanon --enable-mmaudit --enable-mmfields --enable-mmjsonparse --enable-mmpstrucdata --enable-mmsequence --enable-mmutf8fix --enable-mail --enable-omprog --enable-omruleset --enable-omstdout --enable-omuxsock --enable-pmaixforwardedfrom --enable-pmciscoios --enable-pmcisconames --enable-pmlastmsg --enable-pmsnare --enable-libgcrypt --enable-mmnormalize --disable-omudpspoof --enable-relp --disable-snmp --disable-mmsnmptrapd --enable-gnutls=no --enable-mysql --enable-mysql-tests --enable-usertools=no --enable-gt-ksi --enable-libdbi --enable-pgsql=no --enable-omhttpfs --enable-elasticsearch --enable-valgrind --enable-ommongodb=no --enable-omamqp1=no --enable-imjournal --enable-omjournal --enable-compile-warnings=yes" > utils/conf
chmod +x utils/conf
